...
def cache_time(request: WSGIRequest) -> dict:
    ...
    return {
        "category_list_cache_time": category_cache.value if category_cache else DEFAULT_CACHE_TIME,
        "product_list_cache_time": product_cache.value if product_cache else DEFAULT_CACHE_TIME,
