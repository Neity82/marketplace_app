...
class Shop(models.Model):
    ...
    shipping_policy = models.CharField(_("shipping and returns policy"), max_length=50, blank=True)
    refund_policy = models.CharField(_("refund policy"), max_length=50, blank=True)
