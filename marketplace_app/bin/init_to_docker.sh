...
docker-compose -f "$DOCKER_COMPOSE_FILE" exec web python manage.py loaddata seo.json banners.json discount.json users.json shop.json product.json orders.json atribute.json productimages.json