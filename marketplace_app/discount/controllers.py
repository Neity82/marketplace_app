...
class DiscountController():
    ...
    @staticmethod
    def _get_discount_by_mechanism(base_cost: Decimal, mechanism: str,
                                   value: int) -> Decimal:
    ...
    @classmethod
    def get_basket_discount(cls, basket_count: int, 
                            basket_cost: Decimal) -> Decimal:
        ...
        for basket_discount in basket_discounts:
            if (
                (basket_discount.min_products_count <= basket_count and
                    basket_count <= basket_discount.max_products_count) or
                (basket_discount.min_basket_cost <= basket_cost and
                    basket_cost <= basket_discount.max_basket_cost)
            ):
                current_price: Decimal = cls._get_discount_by_mechanism(
                    basket_cost,
